...
function NavScrollExample() {
  return (
      ...
      <Navbar.Brand href="#"  >
        ...
        <Nav.Link href="#action2" style={{"border-radius":"25px", "font-size": "13px", "margin":"1rem 0em", "padding":"6px 1.5em"}} className='d-lg-none navbar-whatsapp-button text-white primary-bg-color'>WHATSAPP</Nav.Link>
